...
let pages = [document.getElementById("home_page"),document.getElementById("calendar_page"), document.getElementById("statistics_page")];
var icons = [document.getElementById("icon_home"), document.getElementById("icon_calendar"), document.getElementById("icon_stats")];
var buttons = [document.getElementById("home_btn"), document.getElementById("calendar_btn"), document.getElementById("statistics_btn")];
...
function getSelectedPosition(item){
	...
	if(item.target.id.includes("stat")){
		position = pos_stats;
	}
